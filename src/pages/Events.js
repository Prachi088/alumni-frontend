        ...
        <div style={styles.grid}>
          {events.map(event => (
            <div key={event.id} style={styles.card}>
              ...
              {role !== "alumni" && (
                <button style={event.registered ? styles.disabledBtn : styles.button} onClick={() => handleRegister(event.id)} disabled={event.registered}>
...
const styles = {
  ...
  button:     { marginTop:"16px", padding:"10px 16px", width:"100%", background:"linear-gradient(135deg, #3b82f6, #60a5fa)", color:"#fff", border:"none", borderRadius:"8px", cursor:"pointer", fontWeight:"700", fontSize:"13px" },
