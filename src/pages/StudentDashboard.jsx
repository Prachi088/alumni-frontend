...
export default function StudentDashboard() {
  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh", fontFamily:"'Open Sans',Arial,sans-serif", background:C.navy, color:C.white, position:"relative", overflowX:"hidden", maxWidth:"100vw" }}>
      <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;500;600;700;800&display=swap" rel="stylesheet"/>
