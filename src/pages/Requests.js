...
const styles = {
  ...
  card:      { background:"linear-gradient(135deg, #fff 0%, #f9fafb 100%)", padding:"20px", borderRadius:"12px", boxShadow:"0 4px 20px rgba(0,0,0,0.06)", border:"1px solid rgba(99,102,241,0.08)", display:"flex", justifyContent:"space-between", alignItems:"center" },
  profile:   { display:"flex", alignItems:"center", gap:"16px" },
  avatar:    { width:"50px", height:"50px", borderRadius:"50%", background:"linear-gradient(135deg, #6366f1, #8b5cf6)", display:"flex", alignItems:"center", justifyContent:"center", fontWeight:800, fontSize:18, color:"#fff" },
  name:      { margin:0, fontSize:"15px", fontWeight:"700", color:"#1e293b" },
  role:      { margin:"4px 0 0", fontSize:"13px", color:"#64748b" },
  actions:   { display:"flex", gap:"12px" },
  acceptBtn: { background:"linear-gradient(135deg, #10b981, #34d399)", color:"#fff", border:"none", padding:"8px 16px", borderRadius:"8px", cursor:"pointer", fontWeight:700, fontSize:"13px" },
  rejectBtn: { background:"linear-gradient(135deg, #ef4444, #f87171)", color:"#fff", border:"none", padding:"8px 16px", borderRadius:"8px", cursor:"pointer", fontWeight:700, fontSize:"13px" },
};
